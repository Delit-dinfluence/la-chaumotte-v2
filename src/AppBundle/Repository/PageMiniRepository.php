...
use App\Entity\PageAccountAdress;
use App\Entity\PageAccountAdressForm;
...
use App\Entity\PageMini;
use App\Entity\PageMiniTranslation;
...
class PageMiniRepository extends ServiceEntityRepository
{
    use EntityRepository;

    public function __construct(RegistryInterface $registry)
    {
        parent::__construct($registry, PageMini::class);
    }
