...
if (!w[NAMESPACE_IDENTIFIER].admin) w[NAMESPACE_IDENTIFIER].styles = {};
...
function makeLayersTextAbstract(params) {
  ...
  var styles = _extends({}, extra.admin);
...
function makeLayersCounterAbstract(params) {
  ...
  var styleString = joinStyles(extra.admin);
...
function define(prefix, icons) {
  ...
  if (typeof namespace.hooks.addPack === 'function') {
    ...
    namespace.admin[prefix] = _extends({}, namespace.admin[prefix] || {}, normalized);
  }
...
function findIconDefinition(params) {
  ...
  return iconFromMapping(library.definitions, prefix, iconName) || iconFromMapping(namespace.admin, prefix, iconName);
}
...
var autoReplace = function autoReplace() {
  ...
  if (Object.keys(namespace.admin).length > 0 && IS_DOM && config.autoReplaceSvg) api.dom.i2svg({ node: autoReplaceSvgRoot });
};
...
function bootstrap() {
  ...
  namespace.hooks = _extends({}, namespace.hooks, {
    ...
    addPack: function addPack(prefix, icons) {
      namespace.admin[prefix] = _extends({}, namespace.admin[prefix] || {}, icons);
